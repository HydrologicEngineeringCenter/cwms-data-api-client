...
public class RatingSpecController
{
	 ...
	 */
	public RatingSpec retrieveRatingSpec(ApiConnectionInfo apiConnectionInfo, RatingSpecEndpointInput ratingSpecEndpointInput)
			throws IOException {
		RatingSpec retVal;
	...
	public RatingSpecs retrieveRatingSpecs(ApiConnectionInfo apiConnectionInfo,
	                                       RatingSpecEndpointInput ratingSpecEndpointInput)
			throws IOException {
		RatingSpecs retVal;
